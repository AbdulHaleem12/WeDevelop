 ...
 *
 * Passes it through the `recore_starter_content` filter before returning.
 *
 * @since recore
 *
 * @return array A filtered array of args for the starter_content.
*/
function recore_p_starter_content() {
	...
	$starter_content = array(
		...
		'nav_menus' => array(
			...
			'primary' => array(
				'name'  => esc_html__( 'Primary menu', 'recore' ),
				'items' => array(
	 ...
	 */
	return apply_filters( 'recore_starter_content', $starter_content );
}